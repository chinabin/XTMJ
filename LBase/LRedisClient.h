...
public:
	...
	bool incrby(const std::string& strKey, int& value);
	...
	//sort set
	bool zincrby(const std::string& strKey, const std::string& increment, const std::string& member);
	bool zincrby(const std::string& strKey, const int increment, const std::string& member);
	bool zincrby(const std::string& strKey, const int increment, const int member);
	//从大到小排列的排名
	bool zrevrank(const std::string& strKey, const std::string& member, int& rank);
	//从大到小排列的排名
	bool zrevrange(const std::string& strKey, const int start, const int stop, std::list<std::string>& members);
	bool zrevrange(const std::string& strKey, const int start, const int stop, std::list<int>& members);
	struct msdata{
		int member;
		int score;
	};
	bool zrevrangeWithScores(const std::string& strKey, const int start, const int stop, std::vector<msdata>& members);

	//set
	bool sadd(const std::string& strKey, const std::string& member, bool& result);
	bool sadd(const std::string& strKey, const int member, bool& result);
	bool smembers(const std::string& strKey, std::vector<int>& members);
	bool sismember(const std::string& strKey, const std::string& member, bool& result);
